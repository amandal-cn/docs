...
- Discover and use pre-built capabilities from our marketplace
...
MCP Hive offers two flexible ways to create custom MCP servers:
...
<Note>
  Learn how to build custom MCP servers by following this [guide](/getting-started/hive-creators).
</Note>
...
## Discover and Use Existing MCP Servers
...
- [For Hive Creators](/getting-started/hive-creators): Learn how to build custom MCP servers
- [For Hive Users](/getting-started/hive-users): Discover how to use existing MCP servers in your applications
- [Key Concepts](/getting-started/key-concepts): Understand the fundamental concepts of MCP Hive
